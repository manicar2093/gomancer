...
`
		...
		It("creates README.md file", func() {
			Expect(dirWithPath("README.md")).Should(testmatchers.BeAnExistingFileWithEqualContent(path.Join("fixtures", "readme.txt")))
		})

		It("creates prisma.config.ts file", func() {
...
`
			Expect(dirWithPath("prisma.config.ts")).Should(testmatchers.BeAnExistingFileAndEqualString(content))
		...
		It("creates core directory", func() {
			...
			Expect(dirWithPath("core/web/components")).Should(BeADirectory())
			Expect(dirWithPath("core/web/components/button/button.templ")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/components/datetime/datetime.templ")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/components/drawer/drawer.templ")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/components/form/form.templ")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/components/formerrors/formerrors.templ")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/components/formtag/formtag.templ")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/components/icon/icon.go")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/components/icon/icon_data.go")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/components/icon/icon_defs.go")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/components/input/input.templ")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/components/label/label.templ")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/components/link/link.templ")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/components/pagination/pagination.templ")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/components/popover/popover.templ")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/components/selectbox/selectbox.templ")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/components/table/table.templ")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/components/toast/toast.templ")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/components/toggle/toggle.templ")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/layouts/drawer.templ")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/layouts/flash_messages.templ")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/layouts/initial.templ")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/layouts/sidemenu.templ")).Should(BeAnExistingFile())
			Expect(dirWithPath("core/web/utils/templui.go")).Should(BeAnExistingFile())
